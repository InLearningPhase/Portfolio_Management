      ...
      Subscribers: [
        {
          ...
          OnSuccessTopicsToPush: ["APPUSERS_ADDED"],
      ...
      Subscribers: [
        {
          Service: "APPUSERS_SERVICE",
          Function: "InsertChannel",
          OnSuccessTopicsToPush: ["APPUSERS_UPDATED"],
          OnFailureTopicsToPush: ["ERROR_RECEIVER"],
    ...
    Subscribers: [
      {
        Service: "APPUSERS_SERVICE",
        Function: "InsertChannel",
        OnSuccessTopicsToPush: ["APPUSERS_DELETED"],
        OnFailureTopicsToPush: ["ERROR_RECEIVER"],
