...
export class ClientsRoutes {
      ...
      this.sns_sqs.listenToService(this.topicArray[i], this.serviceName[i], (() => {
        ...
        return async (result) => {
          ...
          try {
            ...
            console.log("aabbcc: ", result.Filter)
  ...
  @Get(':id')
  getAllProductsByIds(@Param('id') id: number): Promise<ResponseModel<ClientsDto>> {
    try {
  ...
  @Get('/search')
  getAllClientsBySearch(@Req() req: Request) {
    try {

      let requestModel: RequestModelQuery = JSON.parse(req.headers['requestmodel'].toString());
      console.log(requestModel)

      return this.clientsFacade.search(requestModel);
